...
namespace Cent.Core
{
    class CentCompiler : CentTranscompiler
    {
        ...
        public CentCompiler(List<string> inFileNames) : base(inFileNames)
        {
            this.binary = new CentToBinary()
            {
        ...
        {
            this.binary.Execute();
            this.binary.Write(outFileName);
        }
    }

    class CentToBinary : DynamicAssembler
    {
